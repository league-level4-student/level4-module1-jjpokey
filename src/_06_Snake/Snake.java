...
public class Snake {
	...
	public void update() {
		SnakeSegment sgi;
		SnakeSegment sgi2;
		Location newHeadLocation = new Location(getHeadLocation().x,getHeadLocation().y);
		//1. use a switch statement to check on the currentDirection
		//   of the snake and calculate its next x and y position.
		switch(currentDirection) {
		case UP :
			newHeadLocation.x = newHeadLocation.x + 1;
			break;
		case DOWN :
			newHeadLocation.x = newHeadLocation.x - 1;
			break;
		...
		case LEFT :
			newHeadLocation.y = newHeadLocation.y - 1;
			break;
		case RIGHT :
			newHeadLocation.y = newHeadLocation.y + 1;
			break;
	default:
		...
		sgi = snake.get(i); //current
		sgi2 = snake.get(i - 1);
		sgi.setLocation(sgi2.getLocation());
		}
